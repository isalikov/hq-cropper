...
function HqCropper(onSubmit, {
    ...
    const movePortal = (event) => {
        ...
        if (left > sourceWidth - portalSize) {
            left = sourceWidth - portalSize - 3
        }

        if (top > sourceHeight - portalSize) {
            top = sourceHeight - portalSize - 3
        }
    ...
    const resizePortal = (event, actionType) => {
        ...
        if (actionType === 'br') {
            ...
            if (onMouseDownPortalTop + brSize > sourceHeight) {
                brSize = sourceHeight - onMouseDownPortalTop - 3
            }

            if (onMouseDownPortalLeft + brSize > sourceWidth) {
                brSize = sourceWidth - onMouseDownPortalLeft - 3
            }
        ...
        if (actionType === 'tr') {
            ...
            if (onMouseDownPortalLeft + trSize > sourceWidth) {
                trSize = sourceWidth - onMouseDownPortalLeft - 3
        ...
        if (actionType === 'bl') {
            ...
            if (blSize + onMouseDownPortalTop > sourceHeight) {
                ...
                blSize = sourceHeight - onMouseDownPortalTop - 3
            }
    ...
    function handleChange(event) {
        ...
        reader.onload = (data) => {
            ...
            image.onload = () => {
                ...
                if (center) {
                    portalLeft = (sourceWidth - caretSize) / 2
                    portalTop = (sourceHeight - caretSize) / 2
                }
